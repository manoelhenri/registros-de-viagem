...
const PADROES = [
    ...
    // Mesma limitação do Vimeo: sem thumbnail fixa, mostra o nome "Instagram".
    {
...
function videoEmbedHtml(urlBruta, titulo) {
    ...
    return (
          `<div class="${classe} video-facade" data-video-src="${info.src}" data-video-title="${tituloSeguro}" data-video-allow="${IFRAME_ALLOW}">` +
          capaHtml +
